...
<div class="container-fluid container-fh">
  <div class="page-content__header">
    <div>
      <h2 class="page-content__header-heading">Staffs</h2>
      ...
      <div class="col-lg-10">
          <div class="main-container table-container">
              <table class="table table-no-border">
                  ...
                  <?php if($all_staff){ foreach($all_staff as $staff){?>
                      <tr>
                          <td class="table__avatar">
                              <img src="<?php echo base_url()?>/upload/<?php echo $staff['staffimage'];?>" alt="" width="34" height="34" class="rounded-circle">
                  ...
                  <?php }}else{?>
                      <tr>
                          ...
                          <td><strong>No Staff Registered</strong></td>
