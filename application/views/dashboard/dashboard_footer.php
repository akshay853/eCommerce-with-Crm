...
<script src="<?php echo DASHBOARD_DESIGN_PATH;?>vendor/echarts/echarts.min.js"></script>
...
<script src="<?php echo DASHBOARD_DESIGN_PATH;?>vendor/sparkline/jquery.sparkline.min.js"></script>
<script src="<?php echo DASHBOARD_DESIGN_PATH;?>js/preview/sales-dashboard.min.js"></script>
...
<script src="<?php echo DASHBOARD_DESIGN_PATH;?>js/preview/settings-panel.min.js"></script>
...
<div class="slide-nav">
    <div class="slide-nav__header">
        ...
        <img src="<?php echo DASHBOARD_DESIGN_PATH;?>img/logo.png" alt="" class="slide-nav__logo">
    </div>
        ...
        <div class="slide-nav__scrollpane js-scrollable">
            <div class="slide-nav__items">
                <a href="#" class="slide-nav__item">
                    <img src="<?php echo DASHBOARD_DESIGN_PATH;?>img/slidenav/30.png" alt="" class="slide-nav__item-image">
                    <span class="slide-nav__item-text">Storage</span>
                </a>
                <a href="#" class="slide-nav__item">
                    <img src="<?php echo DASHBOARD_DESIGN_PATH;?>img/slidenav/31.png" alt="" class="slide-nav__item-image">
                    <span class="slide-nav__item-text">Search</span>
                </a>
                <a href="#" class="slide-nav__item">
                    <img src="<?php echo DASHBOARD_DESIGN_PATH;?>img/slidenav/32.png" alt="" class="slide-nav__item-image">
                    <span class="slide-nav__item-text">Calendar</span>
                </a>
                <a href="#" class="slide-nav__item">
                    <img src="<?php echo DASHBOARD_DESIGN_PATH;?>img/slidenav/33.png" alt="" class="slide-nav__item-image">
                    <span class="slide-nav__item-text">Mail</span>
                </a>
                <a href="#" class="slide-nav__item">
                    <img src="<?php echo DASHBOARD_DESIGN_PATH;?>img/slidenav/34.png" alt="" class="slide-nav__item-image">
                    <span class="slide-nav__item-text">Images</span>
                </a>
                <a href="#" class="slide-nav__item">
                    <img src="<?php echo DASHBOARD_DESIGN_PATH;?>img/slidenav/35.png" alt="" class="slide-nav__item-image">
                    <span class="slide-nav__item-text">News</span>
                </a>
                <a href="#" class="slide-nav__item">
                    <img src="<?php echo DASHBOARD_DESIGN_PATH;?>img/slidenav/36.png" alt="" class="slide-nav__item-image">
                    <span class="slide-nav__item-text">Maps</span>
                </a>
                <a href="#" class="slide-nav__item">
                    <img src="<?php echo DASHBOARD_DESIGN_PATH;?>img/slidenav/37.png" alt="" class="slide-nav__item-image">
                    <span class="slide-nav__item-text">Market</span>
                </a>
                <a href="#" class="slide-nav__item">
                    <img src="<?php echo DASHBOARD_DESIGN_PATH;?>img/slidenav/38.png" alt="" class="slide-nav__item-image">
                    <span class="slide-nav__item-text">Weather</span>
                </a>
                <a href="#" class="slide-nav__item">
                    <img src="<?php echo DASHBOARD_DESIGN_PATH;?>img/slidenav/39.png" alt="" class="slide-nav__item-image">
                    <span class="slide-nav__item-text">Music</span>
                </a>
                <a href="#" class="slide-nav__item">
                    <img src="<?php echo DASHBOARD_DESIGN_PATH;?>img/slidenav/40.png" alt="" class="slide-nav__item-image">
                    <span class="slide-nav__item-text">Tickets</span>
                </a>
                <a href="#" class="slide-nav__item">
                    <img src="<?php echo DASHBOARD_DESIGN_PATH;?>img/slidenav/41.png" alt="" class="slide-nav__item-image">
...
<script src="<?php echo DASHBOARD_DESIGN_PATH;?>js/preview/slide-nav.min.js"></script>
