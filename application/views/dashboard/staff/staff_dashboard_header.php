...
<div class="page-wrap">
    ...
    <div class="sidebar-section">
        <div class="sidebar-user-a">
            ...
            <div class="sidebar-user-a__name">Staff Dashboard</div>
        ...
        <div>
            ...
            <ul class="sidebar-section-nav">
                  ...
                  <li class="sidebar-section-nav__item">
                    <a class="sidebar-section-nav__link" href="<?php echo base_url()?>staff/view_profile">
                ...
                <li class="sidebar-section-nav__item">
                    <a class="sidebar-section-nav__link" href="<?php echo base_url()?>staff/lead">
                        <span class="sidebar-section-nav__item-icon iconfont-control-panel"></span>
                        <span class="sidebar-section-nav__item-text">lead management</span>
                    </a>
                </li>
                <li class="sidebar-section-nav__item">
                    <a class="sidebar-section-nav__link" href="<?php echo base_url()?>staff/task">
                        <span class="sidebar-section-nav__item-icon iconfont-control-panel"></span>
                        <span class="sidebar-section-nav__item-text">task management</span>
                    </a>
                </li>
                <li class="sidebar-section-nav__item">
                    <a class="sidebar-section-nav__link" href="<?php echo base_url()?>staff/contact">
                        <span class="sidebar-section-nav__item-icon iconfont-control-panel"></span>
                        <span class="sidebar-section-nav__item-text">contact management</span>
                    </a>
                </li>
                <li class="sidebar-section-nav__item">
                    <a class="sidebar-section-nav__link" href="<?php echo base_url()?>staff/sale">
                        <span class="sidebar-section-nav__item-icon iconfont-control-panel"></span>
                        <span class="sidebar-section-nav__item-text">sale management</span>
                    </a>
                </li>
                 <li class="sidebar-section-nav__item">
                    <a class="sidebar-section-nav__link" href="<?php echo base_url()?>staff/feedbacks">
                        <span class="sidebar-section-nav__item-icon iconfont-control-panel"></span>
