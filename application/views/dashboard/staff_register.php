...
<div class="p-signup">
  <form class="p-signup__form" method="post" action="<?php echo base_url();?>register/staff_registration">
    <h2 class="p-signup__form-heading"> STAFF REGISTER</h2>
    <div class="p-signup__form-content">
      <div class="row">
        ...
        <div class="row">
            <div class="form-group col-md-12">
             <label>address</label><textarea required class="form-control" name="address" id="address"></textarea>
        </div>
        </div>
            <div class="row">
      ...
      <div class="row">
        <div class="form-group col-md-12">
          ...
          <input type="email" required class="form-control" id="email" placeholder="you@yourcompany.com">
        </div>
      </div>
           <div class="row">
               <div class="form-group col-md-12">
                    <label>username</label><input class="form-control" required min="6" max="8" type="text" name="username" id="username">
               </div>
           </div>
        
           <div class="row">
               <div class="form-group col-md-12">
                    <label>Password</label><input class="form-control" required min="6" max="8" type="password" name="password" id="password" placeholder="password">
            </div>   
               </div>
        ...
        <div class="row">
            ...
            <div class="p-signup__form-links">
                ...
                <div class="p-signup__form-link">
                    Already have an account?  <a href="<?php echo base_url();?>login/staff_login" class="link-info">Sign In</a>
                </div>
            </div>
        </div>
           </div>
