...
<div class="p-signin">
    <form class="p-signin__form" method="POST" action="<?php echo base_url();?>login/seller_login_action">
    <h2 class="p-signin__form-heading"> seller Login </h2>
    <div class="p-signin__form-content">
      <div class="row">
        <div class="form-group col-md-12">
          <label for="p-signin-work-email">user name</label>
          <input required type="text" name="username" id="username" class="form-control" id="p-signin-work-email" placeholder="username">
        </div>
      </div>
      <div class="row">
        <div class="form-group col-md-12">
          <label for="p-signin-set-password">Password</label>
          <input required type="password" name="password" id="password" class="form-control" id="p-signin-set-password" placeholder="Password">
        </div>
      </div>
      <div>
      ...
      <div class="p-signin__form-links">
        <div class="p-signin__form-link">
          Don't have an account? <a href="<?php echo base_url();?>register/seller_register" class="link-info">register</a>
          <br><a href="<?php echo base_url();?>password/password_reset/seller" class="link-info">forget password</a>
